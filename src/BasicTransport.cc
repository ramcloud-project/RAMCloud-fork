 ...
 */
void
BasicTransport::OutgoingMessage::activate(BasicTransport* t)
{
...
#define MAX_PACKETS 8
    ...
    if (numPackets > 0) {
        ...
        TimeTrace::record(startTime, "start of polling iteration %u, "
                "last poll was %u ns ago", uint32_t(owner->iteration),
                uint32_t(Cycles::toNanoseconds(startTime - lastPollTime)));
#endif
